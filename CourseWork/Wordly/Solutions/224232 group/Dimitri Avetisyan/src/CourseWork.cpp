...
int main()
{
	...
	int letters_count, words_count, s;
	...
	srand(time(0));
	//cout << words[78] << endl;
	//initial_word = (words[rand() % word_5_letters]);
	...
	for (int life = 10; life > 0;)
	{
		...
		for (int k = 0; k < dif; k++)
			if ((entered_word[0] != '1') && (entered_word[0] != '9'))
				...
				{
					cout << "You entered unssoported symbol, please use only English alphabet" << endl;
					break;
				}
		...
		/*if (entered_word[0] == '9')
		{
			int hint;
			if (letters_count == 4)
				while (entered_word[0] != '1' && entered_word[0] != '2' && entered_word[0] != '3' && entered_word[0] != '4')
				{
					cout << "+" << string(86, '-') << "+" << endl;
